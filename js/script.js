$(document).ready(function () {
    ...
    $('#overlay').click(function(e) { 
        ...
        else if ($('.facebook-log-in').css("display") == "block") {
            if($(e.target).closest('.facebook-log-in').length === 0) {
                $('#overlay').css("display", "none"); 
                $('.facebook-log-in').css("display", "none");
                $('body').css("overflow", "auto");
            }
        }
        else if ($('.facebook-sign-up').css("display") == "block") {
            if($(e.target).closest('.facebook-sign-up').length === 0) {
                $('#overlay').css("display", "none"); 
                $('.facebook-sign-up').css("display", "none");
                $('body').css("overflow", "auto");
            }
        }
        else {
    ...
    $('.facebook-log-in-click').click(function() {
        if ($('.sign-up').css("display") == "block") {
            $('.facebook-log-in').css("display", "block");
            $('.sign-up').css("display", "none");
        }
        else if ($('.log-in').css("display") == "block") {
            $('.facebook-log-in').css("display", "block");
    ...
    $('.facebook-sign-up-click').click(function() {
        if ($('.sign-up').css("display") == "block") {
            $('.facebook-sign-up').css("display", "block");
            $('.sign-up').css("display", "none");
        }
        else if ($('.log-in').css("display") == "block") {
            $('.facebook-sign-up').css("display", "block");
